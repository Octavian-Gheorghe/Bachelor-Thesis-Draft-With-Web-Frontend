...
public class SWO
{
    ...
    public double calculateUtility(ActivitySWO a)
    {
        a.setDuri(0);
    ...
    private void scheduleInterruptible(ActivitySWO act)
    {
        ...
        while (totalDur < act.getDurimin())
        {
            ...
            act.getParts().add(new ActivityPartSWO(partId++, cand.ti(), cand.dur(), cand.loc()));
...
/// =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== =========== ===========
    ...
    private List<Constraint> collectConstraints(List<Constraint> list, ActivitySWO a, ActivitySWO b)
    {
    ...
    private void exclude(ActivitySWO act, int L, int R, DomainContext ctx)
    {
    ...
    private void sortActivitiesTemporalDomainsInPriorityQueu(List<ActivitySWO> as)
    {
