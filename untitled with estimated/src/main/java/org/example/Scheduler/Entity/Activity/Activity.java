...
public class Activity
{
    ...
    private List<TemporalInterval> F;
    private List<Location> Loci;
    ...
    public Activity(int id, String name, int durimax, int durimin, List<TemporalInterval> F,  List<Location> Loci)
    {
        this.id = id;
        this.name = name;
    ...
    public Activity(int id, String name, int durimax, int durimin, int smax, int smin, int dmax, int dmin, List<TemporalInterval> F,  List<Location> Loci)
    {
        this.id = id;
        this.name = name;
        this.durimax = durimax;
