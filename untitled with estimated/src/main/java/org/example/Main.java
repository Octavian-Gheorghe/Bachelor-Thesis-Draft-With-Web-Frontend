...
//        l1.add(l11);
//        l1.add(l12);
//        TemporalInterval ta1 = new TemporalInterval(0, 25);
//        TemporalInterval ta2 = new TemporalInterval(30, 60);
//        List<TemporalInterval> t1 = new ArrayList<>();
//        t1.add(ta1);
//        t1.add(ta2);
...
//        l2.add(l11);
//        TemporalInterval tb1 = new TemporalInterval(2, 11);
//        TemporalInterval tb2 = new TemporalInterval(14, 19);
//        List<TemporalInterval> t2 = new ArrayList<>();
//        t2.add(tb1);
//        t2.add(tb2);
...
//
//        //ACTIVITY D
//        TemporalInterval td1 = new TemporalInterval(11, 14);
//        List<TemporalInterval> t4 = new ArrayList<>();
//        t4.add(td1);
//        Activity D = new Activity(4, "D", 3, 3, t4, l1);
//
//
//        //ACTIVITY E
//        TemporalInterval te1 = new TemporalInterval(2, 3);
//        List<TemporalInterval> t5 = new ArrayList<>();
//        t5.add(te1);
//        Activity E = new Activity(5, "E", 1, 1, t5, l1);
//
//
//        //ACTIVITY F
//        TemporalInterval tf1 = new TemporalInterval(17, 19);
//        List<TemporalInterval> t6 = new ArrayList<>();
//        t6.add(tf1);
...
//        l3.add(l12);
//        TemporalInterval tc1 = new TemporalInterval(3, 19);
//        List<TemporalInterval> t3 = new ArrayList<>();
//        t3.add(tc1);
...
// ACTIVITY Z
        ...
        List<Activity> Li = new ArrayList<>();
        Li.add(A);
        Li.add(B);
        Li.add(C);
        Li.add(D);
        ...
        Li.add(AV1);
        Li.add(AW1);//75
        Schedule Sch = new Schedule(Li);
        List<Constraint> lo = new ArrayList<>();
        List<UnaryUtility> u = new ArrayList<>();
        SWO swo = new SWO(Sch, lo, dm, new ArrayList<>(), new ArrayList<>());
        ...
        for (Activity act : swo.getP().getActivities()) {
            System.out.println(act.getName() + " : " + act.getId());
            for (ActivityPart actp : act.getParts()) {
    ...
    public static void analyzeScheduleCoverage(List<Activity> activities) {
        int minStart = Integer.MAX_VALUE;
        int maxEnd = Integer.MIN_VALUE;
        int totalScheduledTime = 0;

        for (Activity activity : activities) {
            for (ActivityPart part : activity.getParts()) {
